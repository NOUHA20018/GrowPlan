...
class AdminController extends Controller
{
    ...
    public function dashboard()
    {
        ...
        return view('admin.dashboard', compact('pendingCount','validatedCount','refusedCount'));
    }
    ...
    public function formateurs(){
       ...
       ->withCount([
            ...
            'coursInscrits as coursInscrits_count',
            'categories',
            'quizzes'
        ])
        ...
        //        return $formateur;
        //    });
        // $cours_valides_count = Cour::where('user_id',);
