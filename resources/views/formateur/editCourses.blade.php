<x-app-layout>
    <x-slot name="header">
        ...
        <h1 class="text-3xl mt-4 p-6 font-bold text-gray-800">Update Courses</h1>
    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow sm:rounded-lg p-6">
                ...
                <form action="{{route('formateur.update.courses')}}" method="POST" class="space-y-6" enctype="multipart/form-data">
                    @csrf
                    <div>
