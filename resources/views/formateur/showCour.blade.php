      ...
      <div class="form-container">
        ...
        <div class="left-column">
          ...
          <div class="form-group">
            ...
            <button type="button" onclick="enableEdit('title-input')" class="edit-button">✏️Edit Title</button>
            </div>
          ...
          <div class="form-group">
            ...
            <button type="button" onclick="enableEdit('description-input')" class="edit-button">✏️Edit Description</button>
            </div>
            <div class="input-group">
          ...
          <div class="form-group">
            <div class="flex justify-between ">
            <label for="description-input"><strong>Image :</strong></label>
            <button type="button" onclick="enableEdit('image-input')" class="edit-button">✏️Edit Image</button>
            </div>
          ...
          <div class="form-group">
            ...
            <button type="button" onclick="enableEdit('prix-input')" class="edit-button">✏️Edit Prix</button>
            </div>
            <div class="input-group">
          ...
          <div class="form-group">
            ...
            <button type="button" onclick="enableEdit('date-input')" class="edit-button">✏️Edit Date Creation</button>
            </div>
            <div class="input-group">
          ...
          <div class="form-group">
            <div class="flex justify-between ">
            <label for="categorie-id"><strong>Catégorie :</strong></label>
            <button type="button" onclick="enableEdit('categorie_id-input')" class="edit-button">✏️Edit Categorie</button>
            </div>
            <div class="select-group">
              <select name="categorie_id" class="select">
              ...
              <a style="color:black;background-color: gray;padding:5px ;border-radius:8px ;" href="{{ route('formateur.categories.create')}}" ><strong>+ Ajouter</strong></a>
            </div>
          </div>
        </div>
